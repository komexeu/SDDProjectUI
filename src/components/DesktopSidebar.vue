  ...
  <aside class="sidebar" :class="{ collapsed }">
    ...
    <div class="sidebar-user" v-show="!collapsed">
      ...
      <div v-else class="user-nav">
        ...
        <button class="logout-btn" @click="$emit('logout')" title="登出" aria-label="登出">
    ...
    <div class="accordion" v-show="!collapsed">
      <div class="accordion-item">
        <div class="accordion-header" @click="$emit('toggle-accordion', 'order')">
          <span>訂單</span>
      ...
      <div class="accordion-item">
        <div class="accordion-header" @click="$emit('toggle-accordion', 'product')">
          <span>產品</span>
      ...
      <div class="accordion-item">
        <div class="accordion-header" @click="$emit('toggle-accordion', 'inventory')">
          <span>庫存</span>
...
defineEmits(['toggle-collapse', 'toggle-accordion', 'logout'])
</script>
<style>
.sidebar {
  width: 220px;
